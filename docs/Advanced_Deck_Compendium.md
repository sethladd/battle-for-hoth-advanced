...
## Section cards (both sides — 13 cards)
...
Each player may choose one leader; shuffle in its 3 cards and apply its passive for the whole game.

### Leia Organa (Rebel)

*Passive — Command Network — the first unit you order each turn rolls +1 attack die.*
...
*Passive — The Force — once per turn you may reroll one of your attack dice.*
...
*Passive — Scoundrel's Luck — you hold +1 command card, and your reaction cards' attacks roll +1 die.*
...
*Passive — Fear — when one of your attacks forces a retreat, the target retreats 1 extra hex.*
...
*Passive — Fleet Command — you hold +1 command card (superior battle coordination).*
